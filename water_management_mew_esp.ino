...
const char put_Thing[] = "water_management_new_things";
const char get_Property3[] = "switch";
const char host[] = "dcs.glaitm.org"; 
const int httpsPort = 7080;
const char appKey[]= "76087eb1-a098-46dd-9c2e-817db091e1bd";

const char Thing[] = "water_management_new_things";
const char Property[] = "volume1";

const char Thing1[] = "water_management_new_things";
const char Property1[] ="volume2";

const char Thing2[] = "water_management_new_things";
const char Property2[] = "flowrate1";

const char Thing3[] = "water_management_new_things";
const char Property3[] = "flowrate2";

const char Thing4[] = "water_management_new_things";
const char Property4[] = "phmeter";

const char Thing5[] = "water_management_new_things";
const char Property5[] = "turbidity";

const char Thing6[] = "water_management_new_things";
